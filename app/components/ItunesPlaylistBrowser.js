      ...
      <div className="bg-white w-full h-full sm:w-full sm:h-full sm:rounded-lg sm:shadow-xl sm:max-w-6xl flex flex-col overflow-hidden">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-gray-600">
              ...
              {selectedSongs.length > 0 && (
                <span className="ml-2 text-blue-600 font-medium">• {selectedSongs.length} selected</span>
              )}
            </p>
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <div className="flex-1 sm:max-w-xs flex gap-1">
                ...
                {sortBy === 'dateAdded' && (
                  <button
                    ...
                    className="px-1 py-1 border border-gray-300 rounded hover:bg-gray-50"
              ...
              {selectedSongs.length > 0 && (
                <button
                  ...
                  className="px-2 py-1 text-sm text-red-600 border border-red-300 rounded hover:bg-red-50 whitespace-nowrap"
                >
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden" style={{ WebkitOverflowScrolling: 'touch', overscrollBehavior: 'contain', touchAction: 'pan-y' }}>
          {loading ? (
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                <p className="text-gray-500 text-base mb-2">No songs found</p>
              ...
              {currentSongs.map((song) => {
                ...
                return (
                  <div
                    ...
                    className={`p-2 mb-1 rounded border cursor-pointer transition-all ${
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="text-sm sm:text-base font-semibold text-gray-900 truncate">{song.title}</h3>
                            ...
                            <div className="flex items-center gap-1 mt-1">
                              <span 
                                className="inline-block px-1 py-0.5 text-xs rounded font-medium"
                                style={{ 
            ...
            <div className="px-2 py-1 border-b bg-gray-50">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="px-1 text-sm">{currentPage}/{totalPages}</span>
                  <button
