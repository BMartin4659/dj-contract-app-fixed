...
const ItunesPlaylistBrowser = ({ isOpen, onClose, selectedSongs = [], onSongsChange, onViewPlaylist }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50" style={{ overscrollBehavior: 'contain' }}>
      <div className="w-full h-full sm:h-full sm:max-w-6xl sm:mx-auto sm:my-4 sm:rounded-lg sm:shadow-xl flex flex-col bg-white overflow-hidden" style={{ height: '100vh', height: '100dvh' }}>
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden bg-gray-50 min-h-0" style={{ WebkitOverflowScrolling: 'touch', overscrollBehavior: 'contain', touchAction: 'pan-y' }}>
          {loading ? (
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                <div className="animate-spin rounded-full h-6 w-6 sm:h-8 sm:w-8 border-b-2 border-blue-600 mx-auto mb-1 sm:mb-2"></div>
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                <p className="text-gray-500 text-sm sm:text-base mb-1 sm:mb-2">No songs found</p>
                <p className="text-gray-400 text-xs sm:text-sm">Try adjusting your search or filter</p>
              </div>
            </div>
          ) : (
            <div className="p-0.5">
