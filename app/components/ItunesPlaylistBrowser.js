    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-6xl h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">DJ Bobby Drake&apos;s Music Library</h2>
            ...
            <div className="lg:w-48 flex gap-2">
              ...
              {sortBy === 'dateAdded' && (
                <button
                  ...
                  className="px-3 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
        ...
        <div className="p-6 border-t bg-gray-50">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              ...
              >
                Done ({selectedSongs.length} selected)
              </button>
            </div>
          </div>
        </div>
